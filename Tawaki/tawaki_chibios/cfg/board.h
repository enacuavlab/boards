...
#define	PA03_AUX_A4                    3U
#define	PA04                           4U
#define	PA05                           5U
#define	PA06_AUX_B1                    6U
...
#define	PB12_SPI2_EXTERNAL_CS          12U
#define	PB13                           13U
...
#define	PE03                           3U
#define	PE04_SPI4_INTERNAL_CS          4U
...
#define	LINE_A03_AUX_A4                PAL_LINE(GPIOA, 3U)
#define	LINE_A06_AUX_B1                PAL_LINE(GPIOA, 6U)
...
#define	LINE_B12_SPI2_EXTERNAL_CS      PAL_LINE(GPIOB, 12U)
...
#define	LINE_D05_UART2_TX              PAL_LINE(GPIOD, 5U)
#define	LINE_D06_UART2_RX              PAL_LINE(GPIOD, 6U)
#define	LINE_D08_UART3_TX              PAL_LINE(GPIOD, 8U)
#define	LINE_D09_UART3_RX              PAL_LINE(GPIOD, 9U)
...
#define	LINE_E04_SPI4_INTERNAL_CS      PAL_LINE(GPIOE, 4U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_INPUT(PA00_AUX_A1) | \
					 ...
					 PIN_MODE_INPUT(PA03_AUX_A4) | \
					 PIN_MODE_INPUT(PA04) | \
					 PIN_MODE_INPUT(PA05) | \
					 PIN_MODE_INPUT(PA06_AUX_B1) | \
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_OPENDRAIN(PA00_AUX_A1) | \
					 ...
					 PIN_OTYPE_OPENDRAIN(PA03_AUX_A4) | \
					 PIN_OTYPE_PUSHPULL(PA04) | \
					 PIN_OTYPE_PUSHPULL(PA05) | \
					 PIN_OTYPE_OPENDRAIN(PA06_AUX_B1) | \
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PA00_AUX_A1) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PA03_AUX_A4) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA04) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA05) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA06_AUX_B1) | \
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_PULLDOWN(PA00_AUX_A1) | \
					 ...
					 PIN_PUPDR_PULLDOWN(PA03_AUX_A4) | \
					 PIN_PUPDR_PULLDOWN(PA04) | \
					 PIN_PUPDR_PULLDOWN(PA05) | \
					 PIN_PUPDR_PULLDOWN(PA06_AUX_B1) | \
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_HIGH(PA00_AUX_A1) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(PA03_AUX_A4) | \
					 PIN_ODR_LEVEL_LOW(PA04) | \
					 PIN_ODR_LEVEL_LOW(PA05) | \
					 PIN_ODR_LEVEL_HIGH(PA06_AUX_B1) | \
...
#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(PA00_AUX_A1, 0) | \
					 ...
					 PIN_AFIO_AF(PA03_AUX_A4, 0) | \
					 PIN_AFIO_AF(PA04, 0) | \
					 PIN_AFIO_AF(PA05, 0) | \
					 PIN_AFIO_AF(PA06_AUX_B1, 0) | \
...
#define VAL_GPIOB_MODER                 (PIN_MODE_INPUT(PB00_AUX_B3) | \
					 ...
					 PIN_MODE_OUTPUT(PB12_SPI2_EXTERNAL_CS) | \
					 PIN_MODE_INPUT(PB13) | \
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_OPENDRAIN(PB00_AUX_B3) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PB12_SPI2_EXTERNAL_CS) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PB00_AUX_B3) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PB12_SPI2_EXTERNAL_CS) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_PULLDOWN(PB00_AUX_B3) | \
					 ...
					 PIN_PUPDR_FLOATING(PB12_SPI2_EXTERNAL_CS) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_HIGH(PB00_AUX_B3) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(PB12_SPI2_EXTERNAL_CS) | \
...
#define VAL_GPIOB_AFRH			(PIN_AFIO_AF(PB08_SRVB3, 2) | \
					 ...
					 PIN_AFIO_AF(PB12_SPI2_EXTERNAL_CS, 0) | \
					 PIN_AFIO_AF(PB13, 0) | \
...
#define VAL_GPIOE_MODER                 (PIN_MODE_ALTERNATE(PE00_RC1) | \
					 ...
					 PIN_MODE_INPUT(PE03) | \
					 PIN_MODE_OUTPUT(PE04_SPI4_INTERNAL_CS) | \
...
#define VAL_GPIOE_OTYPER                (PIN_OTYPE_PUSHPULL(PE00_RC1) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PE04_SPI4_INTERNAL_CS) | \
...
#define VAL_GPIOE_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PE00_RC1) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PE04_SPI4_INTERNAL_CS) | \
...
#define VAL_GPIOE_PUPDR                 (PIN_PUPDR_FLOATING(PE00_RC1) | \
					 ...
					 PIN_PUPDR_FLOATING(PE04_SPI4_INTERNAL_CS) | \
...
#define VAL_GPIOE_ODR                   (PIN_ODR_LEVEL_HIGH(PE00_RC1) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(PE04_SPI4_INTERNAL_CS) | \
...
#define VAL_GPIOE_AFRL			(PIN_AFIO_AF(PE00_RC1, 8) | \
					 ...
					 PIN_AFIO_AF(PE03, 0) | \
					 PIN_AFIO_AF(PE04_SPI4_INTERNAL_CS, 0) | \
...
#define AF_LINE_D05_UART2_TX             7U
#define AF_PD06_UART2_RX                 7U
#define AF_LINE_D06_UART2_RX             7U
#define AF_PD08_UART3_TX                 7U
#define AF_LINE_D08_UART3_TX             7U
#define AF_PD09_UART3_RX                 7U
#define AF_LINE_D09_UART3_RX             7U
